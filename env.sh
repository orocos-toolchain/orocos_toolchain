...
export PATH=`rospack find orogen`/bin:`rosstack find orocos_toolchain`/.gems/bin:$PATH
...
export PATH=$envpath/orogen/bin:$envpath/.gems/bin:$PATH
...
export PATH=$PWD/orogen/bin:$PWD/.gems/bin:$PATH
